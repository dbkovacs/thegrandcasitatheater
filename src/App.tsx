      ...
      <div className="bg-brand-dark min-h-screen text-white">
        <header className="bg-black/30 shadow-lg backdrop-blur-sm sticky top-0 z-50">
          <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
            <Link to="/" className="text-2xl font-serif text-brand-gold font-bold tracking-wider">The Grand Casita Theater</Link>
            <div className="space-x-6">
              <Link to="/" className="text-yellow-300/80 hover:text-white transition font-semibold">Home</Link>
              <Link to="/history" className="text-yellow-300/80 hover:text-white transition font-semibold">History</Link>
